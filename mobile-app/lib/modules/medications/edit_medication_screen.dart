...
class _EditMedicationScreenState extends ConsumerState<EditMedicationScreen> {
  ...
  bool get _isDirty {
    return _nameController.text != widget.medication.name ||
        ...
        _endDateController.text != (widget.medication.endDate ?? '') ||
        _selectedTimes.length != widget.medication.schedules.length;
  }
  ...
  void initState() {
    ...
    _selectedTimes = widget.medication.schedules.map((s) {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(toolbarHeight: 52, title: const Text('Edit Medication')),
        body: Form(
          key: _formKey,
          child: ListView(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: _isSaving
                    ...
                    : const Text('UPDATE MEDICATION', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
              ),
